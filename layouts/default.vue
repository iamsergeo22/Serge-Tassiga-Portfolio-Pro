<template>
  <div class="content-wrapper bg-black font-sans flex flex-col min-h-screen" :class="theme">
    <header class="">
      <nav class="container mx-auto flex flex-wrap justify-between lg:justify-around items-center py-8 text-white bg-black">
        <div>
          <nuxt-link v-if="theme === 'theme-light'" to="/"><h1 class="text-4xl texte-white font-extrabold">S</h1></nuxt-link>
          <nuxt-link v-else to="/"><h1 class="text-4xl text-white font-extrabold">S</h1></nuxt-link>
        </div>
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/#projects" v-scroll-to="'#projects'" class="text-white hover:text-white">Projects</a>
            <nuxt-link v-else to="/#projects" v-scroll-to="'/#projects'" class="text-white hover:text-white">Projects</nuxt-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#about" v-scroll-to="'#about'" class="text-white hover:text-white">About</a>
            <nuxt-link v-else to="/#about" v-scroll-to="'/#about'" class="text-white hover:text-white">About Me</nuxt-link>
          </li>
          <li>
            <a v-if="$route.path === '/'" href="/#contact" v-scroll-to="'#contact'" class="text-white hover:text-white">Contact</a>
            <nuxt-link v-else to="/#contact" v-scroll-to="'/#contact'" class="text-white hover:text-white">Contact</nuxt-link>
          </li>
         <!--  <li>
        ...
        <ul class="flex items-center space-x-8">
          <li>
            <a href="mailto:s.tassiga@alustudent.com" class="text-black hover:text-gray-400">
              ...
              width="20" height="20" role="img" xmlns="http://www.w3.org/2000/svg"
                   viewBox="0 0 512 512">
          ...
          <li>
            <a href="https://www.linkedin.com/in/serge-anan-tassiga-759b6b190/" target="_blank" class="text-white hover:text-gray-400">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" class="text-white hover:text-gray-400" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
            </a>
          </li>
        </ul>
      </div>
